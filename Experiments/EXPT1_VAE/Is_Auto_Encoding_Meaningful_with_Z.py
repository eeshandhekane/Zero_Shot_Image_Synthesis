...
Constraint_T_L2 = tf.nn.l2_loss(Z - Y_true)
...
#log_file = open('Log_File_Reconstruction_with_Z.txt', 'a')
...
for iteration in range(ITR) :
	...
	if iteration%RECORD_ITR == 0:
		X_batch_te, Y_batch_te = mnist.train.next_batch(20)
		...
		np.save('Reconstructed_Dataset/Reconstructed_Images_with_Z_' + str(iteration), im_data_np)
		os.system('mkdir Models/Iteration_with_Z_' + str(iteration))
		saver.save(sess, 'Models/Iteration_with_Z_' + str(iteration) + '/Intermediate_Model_with_Z_' + str(iteration))

...
# ATTR_B has a small neglected part-- The dtype is default tf.float32, but stddev = ? [MISSING]
# Names are missing for SAM_logstd
...
SAM_B_mu_A0 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_mu_A0')
SAM_W_logstd_A0 = tf.Variable(tf.truncated_normal([LATENT_DIM, LATENT_DIM], stddev = 0.1), name = 'SAM_W_logstd_A0')
SAM_B_logstd_A0 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_logstd_A0')
...
ATT_B1_A0 = tf.Variable(tf.truncated_normal([1], stddev = 0.1), name = 'ATT_B1_A0')
...
SAM_B_mu_A1 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_mu_A1')
SAM_W_logstd_A1 = tf.Variable(tf.truncated_normal([LATENT_DIM, LATENT_DIM], stddev = 0.1), name = 'SAM_W_logstd_A1')
SAM_B_logstd_A1 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_logstd_A1')
...
ATT_B1_A1 = tf.Variable(tf.truncated_normal([1], stddev = 0.1), name = 'ATT_B1_A1')
...
SAM_B_mu_A2 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_mu_A2')
SAM_W_logstd_A2 = tf.Variable(tf.truncated_normal([LATENT_DIM, LATENT_DIM], stddev = 0.1), name = 'SAM_W_logstd_A2')
SAM_B_logstd_A2 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_logstd_A2')
...
ATT_B1_A2 = tf.Variable(tf.truncated_normal([1], stddev = 0.1), name = 'ATT_B1_A2')
# 0th Capsule Forward Pass
...
SAM_B_mu_A3 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_mu_A3')
SAM_W_logstd_A3 = tf.Variable(tf.truncated_normal([LATENT_DIM, LATENT_DIM], stddev = 0.1), name = 'SAM_W_logstd_A3')
SAM_B_logstd_A3 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_logstd_A3')
...
ATT_B1_A3 = tf.Variable(tf.truncated_normal([1], stddev = 0.1), name = 'ATT_B1_A3')
# 0th Capsule Forward Pass
...
SAM_B_mu_A4 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_mu_A4')
SAM_W_logstd_A4 = tf.Variable(tf.truncated_normal([LATENT_DIM, LATENT_DIM], stddev = 0.1), name = 'SAM_W_logstd_A4')
SAM_B_logstd_A4 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_logstd_A4')
...
ATT_B1_A4 = tf.Variable(tf.truncated_normal([1], stddev = 0.1), name = 'ATT_B1_A4')
# 0th Capsule Forward Pass
...
SAM_B_mu_A5 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_mu_A5')
SAM_W_logstd_A5 = tf.Variable(tf.truncated_normal([LATENT_DIM, LATENT_DIM], stddev = 0.1), name = 'SAM_W_logstd_A5')
SAM_B_logstd_A5 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_logstd_A5')
...
ATT_B1_A5 = tf.Variable(tf.truncated_normal([1], stddev = 0.1), name = 'ATT_B1_A5')
# 0th Capsule Forward Pass
...
SAM_B_mu_A6 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_mu_A6')
SAM_W_logstd_A6 = tf.Variable(tf.truncated_normal([LATENT_DIM, LATENT_DIM], stddev = 0.1), name = 'SAM_W_logstd_A6')
SAM_B_logstd_A6 = tf.Variable(tf.truncated_normal([LATENT_DIM], stddev = 0.1), name = 'SAM_B_logstd_A6')
...
ATT_B1_A6 = tf.Variable(tf.truncated_normal([1], stddev = 0.1), name = 'ATT_B1_A6')
# 0th Capsule Forward Pass
...
# All Capsules
Y_rec = tf.nn.softmax(Y_7_1_A0 + Y_7_1_A1 + Y_7_1_A2 + Y_7_1_A3 + Y_7_1_A4 + Y_7_1_A5 + Y_7_1_A6)
...
print('[INFO] Printing Trainable Variables ... ' + 'Trainable Variables Count : ' + str(len(trainable_variables)))
for item in trainable_variables :
	print('[INFO] 		' + str(item.name))
# A0 trainables
trainable_variables_A0 = [item for item in trainable_variables if 'A0' in item.name]
print('[INFO] Trainable Variables A0 with Count : ' + str(len(trainable_variables_A0)))
for item in trainable_variables_A0 :
	print('[INFO] 		' + str(item.name))
# A1 trainables	
trainable_variables_A1 = [item for item in trainable_variables if 'A1' in item.name]
print('[INFO] Trainable Variables A1 with Count : ' + str(len(trainable_variables_A1)))
for item in trainable_variables_A1 :
	print('[INFO] 		' + str(item.name))
# A2 trainables
trainable_variables_A2 = [item for item in trainable_variables if 'A2' in item.name]
print('[INFO] Trainable Variables A2 with Count : ' + str(len(trainable_variables_A2)))
for item in trainable_variables_A2 :
	print('[INFO] 		' + str(item.name))
# A3 trainables
trainable_variables_A3 = [item for item in trainable_variables if 'A3' in item.name]
print('[INFO] Trainable Variables A3 with Count : ' + str(len(trainable_variables_A3)))
for item in trainable_variables_A3 :
	print('[INFO] 		' + str(item.name))
# A4 trainables
trainable_variables_A4 = [item for item in trainable_variables if 'A4' in item.name]
print('[INFO] Trainable Variables A4 with Count : ' + str(len(trainable_variables_A4)))
for item in trainable_variables_A4 :
	print('[INFO] 		' + str(item.name))
# A5 trainables
trainable_variables_A5 = [item for item in trainable_variables if 'A5' in item.name]
print('[INFO] Trainable Variables A5 with Count : ' + str(len(trainable_variables_A5)))
for item in trainable_variables_A5 :
	print('[INFO] 		' + str(item.name))
# A6 trainables
trainable_variables_A6 = [item for item in trainable_variables if 'A6' in item.name]
print('[INFO] Trainable Variables A6 with Count : ' + str(len(trainable_variables_A6)))
for item in trainable_variables_A6 :
	print('[INFO] 		' + str(item.name))
# print('[DEBUG] Exiting ... ')
# sys.exit()

...
generated_images_A0 = sess.run(Y_7_1_A0, feed_dict = {ph_A0 : attr_0 , ph_A1 : attr_1 , ph_A2 : attr_2 , ph_A3 : attr_3 , ph_A4 : attr_4 , ph_A5 : attr_5 , ph_A6 : attr_6 , test_noise_A0 : a_noise , test_noise_A1 : a_noise , test_noise_A2 : a_noise , test_noise_A3 : a_noise , test_noise_A4 : a_noise , test_noise_A5 : a_noise , test_noise_A6 : a_noise})
# print('[DEBUG] Shape of generated dataset : ' + str(generated_images_A0.shape)) # It is a list, not array
# print('[DEBUG] Exiting ... ')
# sys.exit()
index = 0
for i in range(l):
	im = generated_images_A0[index]/np.amax(generated_images_A0[index])
	index = index + 1
	cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_A0.mp4')
time.sleep(0.5)
...
attr_6 = np.zeros([l, 1]).astype(np.float32)
a_noise = np.random.normal(0, 1, [l, LATENT_DIM])
generated_images_A1 = sess.run(Y_7_1_A1, feed_dict = {ph_A0 : attr_0 , ph_A1 : attr_1 , ph_A2 : attr_2 , ph_A3 : attr_3 , ph_A4 : attr_4 , ph_A5 : attr_5 , ph_A6 : attr_6 , test_noise_A0 : a_noise , test_noise_A1 : a_noise , test_noise_A2 : a_noise , test_noise_A3 : a_noise , test_noise_A4 : a_noise , test_noise_A5 : a_noise , test_noise_A6 : a_noise})
index = 0
for i in range(l):
	im = generated_images_A1[index]/np.amax(generated_images_A1[index])
	index = index + 1
	cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_A1.mp4')
time.sleep(0.5)
os.system('rm -f temp*.jpg')
time.sleep(0.5)
# A2
...
attr_6 = np.zeros([l, 1]).astype(np.float32)
a_noise = np.random.normal(0, 1, [l, LATENT_DIM])
generated_images_A2 = sess.run(Y_7_1_A2, feed_dict = {ph_A0 : attr_0 , ph_A1 : attr_1 , ph_A2 : attr_2 , ph_A3 : attr_3 , ph_A4 : attr_4 , ph_A5 : attr_5 , ph_A6 : attr_6 , test_noise_A0 : a_noise , test_noise_A1 : a_noise , test_noise_A2 : a_noise , test_noise_A3 : a_noise , test_noise_A4 : a_noise , test_noise_A5 : a_noise , test_noise_A6 : a_noise})
index = 0
for i in range(l):
	im = generated_images_A2[index]/np.amax(generated_images_A2[index])
	index = index + 1
	cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_A2.mp4')
time.sleep(0.5)
os.system('rm -f temp*.jpg')
time.sleep(0.5)
# A3
...
attr_6 = np.zeros([l, 1]).astype(np.float32)
a_noise = np.random.normal(0, 1, [l, LATENT_DIM])
generated_images_A3 = sess.run(Y_7_1_A3, feed_dict = {ph_A0 : attr_0 , ph_A1 : attr_1 , ph_A2 : attr_2 , ph_A3 : attr_3 , ph_A4 : attr_4 , ph_A5 : attr_5 , ph_A6 : attr_6 , test_noise_A0 : a_noise , test_noise_A1 : a_noise , test_noise_A2 : a_noise , test_noise_A3 : a_noise , test_noise_A4 : a_noise , test_noise_A5 : a_noise , test_noise_A6 : a_noise})
index = 0
for i in range(l):
	im = generated_images_A3[index]/np.amax(generated_images_A3[index])
	index = index + 1
	cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_A3.mp4')
time.sleep(0.5)
os.system('rm -f temp*.jpg')
time.sleep(0.5)
# A4
...
attr_6 = np.zeros([l, 1]).astype(np.float32)
a_noise = np.random.normal(0, 1, [l, LATENT_DIM])
generated_images_A4 = sess.run(Y_7_1_A4, feed_dict = {ph_A0 : attr_0 , ph_A1 : attr_1 , ph_A2 : attr_2 , ph_A3 : attr_3 , ph_A4 : attr_4 , ph_A5 : attr_5 , ph_A6 : attr_6 , test_noise_A0 : a_noise , test_noise_A1 : a_noise , test_noise_A2 : a_noise , test_noise_A3 : a_noise , test_noise_A4 : a_noise , test_noise_A5 : a_noise , test_noise_A6 : a_noise})
index = 0
for i in range(l):
	im = generated_images_A4[index]/np.amax(generated_images_A4[index])
	index = index + 1
	cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_A4.mp4')
time.sleep(0.5)
os.system('rm -f temp*.jpg')
time.sleep(0.5)
# A5
...
attr_6 = np.zeros([l, 1]).astype(np.float32)
a_noise = np.random.normal(0, 1, [l, LATENT_DIM])
generated_images_A5 = sess.run(Y_7_1_A5, feed_dict = {ph_A0 : attr_0 , ph_A1 : attr_1 , ph_A2 : attr_2 , ph_A3 : attr_3 , ph_A4 : attr_4 , ph_A5 : attr_5 , ph_A6 : attr_6 , test_noise_A0 : a_noise , test_noise_A1 : a_noise , test_noise_A2 : a_noise , test_noise_A3 : a_noise , test_noise_A4 : a_noise , test_noise_A5 : a_noise , test_noise_A6 : a_noise})
index = 0
for i in range(l):
	im = generated_images_A5[index]/np.amax(generated_images_A5[index])
	index = index + 1
	cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_A5.mp4')
time.sleep(0.5)
os.system('rm -f temp*.jpg')
time.sleep(0.5)
# A6
...
attr_6 = np.ones([l, 1]).astype(np.float32)
a_noise = np.random.normal(0, 1, [l, LATENT_DIM])
generated_images_A6 = sess.run(Y_7_1_A6, feed_dict = {ph_A0 : attr_0 , ph_A1 : attr_1 , ph_A2 : attr_2 , ph_A3 : attr_3 , ph_A4 : attr_4 , ph_A5 : attr_5 , ph_A6 : attr_6 , test_noise_A0 : a_noise , test_noise_A1 : a_noise , test_noise_A2 : a_noise , test_noise_A3 : a_noise , test_noise_A4 : a_noise , test_noise_A5 : a_noise , test_noise_A6 : a_noise})
index = 0
for i in range(l):
	im = generated_images_A6[index]/np.amax(generated_images_A6[index])
	index = index + 1
	cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_A6.mp4')
time.sleep(0.5)
os.system('rm -f temp*.jpg')
time.sleep(0.5)
# Digits
for this_batch_int in range(10):
	...
	for i in range(l):
		...
		index = index + 1
		cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
	os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_Digit_' +  str(this_batch_int) + '.mp4')
	time.sleep(0.5)
	os.system('rm -f temp*.jpg')
	time.sleep(0.5)
# All Zeros
...
for i in range(l):
	...
	index = index + 1
	cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_All_Zeros.mp4')
time.sleep(0.5)
os.system('rm -f temp*.jpg')
time.sleep(0.5)
# All Custom!!
...
attr_6 = np.zeros([l, 1]).astype(np.float32)
a_noise = np.random.normal(0, 1, [l, LATENT_DIM])
generated_images_all_custom = sess.run(Y_rec, feed_dict = {ph_A0 : attr_0 , ph_A1 : attr_1 , ph_A2 : attr_2 , ph_A3 : attr_3 , ph_A4 : attr_4 , ph_A5 : attr_5 , ph_A6 : attr_6 , test_noise_A0 : a_noise , test_noise_A1 : a_noise , test_noise_A2 : a_noise , test_noise_A3 : a_noise , test_noise_A4 : a_noise , test_noise_A5 : a_noise , test_noise_A6 : a_noise})
index = 0
for i in range(l):
	im = generated_images_all_custom[index]
	index = index + 1
	cv2.imwrite('temp' + str(index).zfill(5) + '.jpg', np.reshape(im, [28, 28, 1])*255)
os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_All_Custom.mp4')
time.sleep(0.5)
os.system('rm -f temp*.jpg')
time.sleep(0.5)
####################################################################################################
...
# os.system('ffmpeg -f image2 -r 1/1 -i temp%05d.jpg -vcodec mpeg4 -y ' + 'Test_Digit_All_Zero.mp4')
# time.sleep(0.5)
